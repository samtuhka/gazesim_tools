...
fig.suptitle("Suoritustarkkuus", fontsize = 20)
...
data = np.load("ajo.npy")

for i,p in enumerate(data):
    loc = points[i,1]
    result = p[1]
    axes[1,0].text(loc[0], loc[1] + 25, "%.1f" % (result*100) + "%",  horizontalalignment='center', fontsize = 18)
...
for i,p in enumerate(data):
    loc = points[i,1]
    result = p[0]
    axes[0,0].text(loc[0], loc[1] + 25, "%.1f" % (result*100) + "%", horizontalalignment='center', fontsize = 18)
...
data = np.load("dark.npy")


for i,p in enumerate(data):
    loc = points[i,1]
    result = p[1]
    axes[1,1].text(loc[0], loc[1] + 25, "%.1f" % (result*100) + "%",  horizontalalignment='center', fontsize = 18)
...
for i,p in enumerate(data):
    loc = points[i,1]
    result = p[0]
    axes[0,1].text(loc[0], loc[1] + 25, "%.1f" % (result*100) + "%",   horizontalalignment='center', fontsize = 18)
